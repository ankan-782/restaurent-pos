			...
			<div className="max-w-7xl mx-auto px-sm lg:px-lg py-12">
				<div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-8 mb-12">
					...
					<div className="space-y-4 md:col-span-2 lg:col-span-2">
						...
						<p className="text-body-sm text-body leading-relaxed max-w-[360px]">
							A modern, high-performance point-of-sale interface
							designed for swift and seamless restaurant order
							management.
						</p>
					</div>
					...
					<nav>
						...
						<ul className="space-y-2">
							<li>
								<Link
									href="/"
									className="text-body-sm hover:text-ink transition-colors"
								>
									Products List
								</Link>
							</li>
				...
				<div className="border-t border-hairline pt-8 flex flex-col md:flex-row justify-between items-center gap-4">
					<p className="text-caption text-mute text-center md:text-left">
						&copy; {new Date().getFullYear()} Restaurant POS - New
						Order Module Assessment. All rights reserved.
					</p>
