...
export function CouponInput() {
	...
	const handleApply = () => {
		...
		dispatch(
			applyCoupon(normalizedCode as "SAVE10" | "SAVE20" | "WELCOME"),
		);
		setCode("");
		setError("");
			...
			<div className="bg-warning-soft border border-warning rounded-md p-4">
				<div className="flex items-center justify-between">
					<div className="flex items-center gap-3">
						...
						<div>
							<p className="text-body-sm font-medium text-warning-deep">
								{appliedCoupon}
							</p>
	...
	return (
		<div className="bg-canvas rounded-md border border-hairline p-4">
			<h4 className="text-body-md font-semibold text-ink mb-3">
				Apply Coupon
			</h4>
			...
			{success && (
				<p className="text-success text-body-sm mt-2">{success}</p>
			)}
			<p className="text-caption text-body mt-3">
				Available: SAVE10 (10% off), SAVE20 (20% off), WELCOME ($5 off,
				min $20)
			</p>
		</div>
	);
