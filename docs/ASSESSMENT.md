...
5. Shopping cart with add/remove/update quantity and localStorage persistence.
6. Order summary (Subtotal, VAT, Discount, Coupon, Grand Total).
7. Coupon support (SAVE10, SAVE20, WELCOME).
8. Checkout confirmation modal.
9. POST order to API.
